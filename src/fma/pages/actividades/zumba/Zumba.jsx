...
export const Zumba = () => {
  ...
  const handleZumbaTurnos = () =>{
    navigate('/zumbaTurnos', {
      replace: true
    })
  };
          ...
          >
            ...
            <Grid item
              ...
              justifyContent="center">
                ...
                <Typography sx={{mb: 3, textAlign: 'center', fontWeight: 'bold', fontSize: {xs: '22px', md: '34px', sm: '32px'}}} >¿Qué es Zumba?</Typography>
                ...
                <Grid item xs={5}>
                  ...
                  <Button 
                    onClick={handleZumbaTurnos} 
                    variant='contained' 
                    sx={{mt: 8, backgroundColor: 'secondary.main', display: {xs:'none', md:'block' }}}>Turno Online</Button>
                </Grid>
              </Grid>
            </Grid>
