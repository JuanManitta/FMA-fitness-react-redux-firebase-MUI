import { AccessAlarmsRounded, UnfoldLess } from '@mui/icons-material'
...
export const CrossfitTurnos = () => {
  ...
  return (
    ...
    <Grid container
      ...
      direction="row"
      sx={{ minHeight: 'calc(100vh)', p:2, backgroundColor: '#F3F5FA', display: {xs: 'grid', md: 'flex' }}}
      >
        <Grid item
        xs={12}
        md={4} 
        >
         <img className='img_activities' src={crossfit} alt="" />
         <Typography sx={{mt:3}}>
            ...
            sx={{width:'90%', boxShadow: 3, p: 1, mt: 2, borderRadius: 2, display: {xs: isOpen2 === true ? 'flex' : 'none'}  }}>
                ...
                </Grid>
                {
                      ...
                      <Grid 
                          ...
                          <Grid item> 
                            <Button
                                disabled={numbOfActivities || !suscripted} 
                                onClick={ ()=> getData(item)} 
                                variant="contained">
                                    <Typography 
                                        sx={{display:{xs: suscripted ? 'none' : 'block' }}}>
